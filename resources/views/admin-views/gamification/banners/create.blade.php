...
@section('title', translate('Add Gamification Banner'))
...
<div class="content container-fluid">
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>{{ translate('Add Gamification Banner') }}</span>
        </h1>
    </div>

    <form action="{{ route('admin.gamification.banners.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row g-2">
            <div class="col-lg-8">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="{{ translate('e.g., Spin & Win!') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="input-label">{{ translate('Subtitle') }}</label>
                                    <input type="text" name="subtitle" class="form-control" placeholder="{{ translate('e.g., Play now and win prizes') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="game_id" class="form-control" required>
                                        <option value="">{{ translate('Select Game') }}</option>
                                        @foreach($games as $game)
                                        <option value="{{ $game->id }}">{{ $game->name }} ({{ ucwords(str_replace('_',' ',$game->type)) }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="placement" class="form-control" required>
                                        <option value="home">{{ translate('Home Screen') }}</option>
                                        <option value="restaurant">{{ translate('Restaurant Page') }}</option>
                                        <option value="checkout">{{ translate('Checkout Page') }}</option>
                                        <option value="cart">{{ translate('Cart Page') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="button_text" class="form-control" value="Play Now">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="background_color" class="form-control" value="#8DC63F">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" name="button_color" class="form-control" value="#F5D800">
                        </div>
                        <div class="form-group">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary btn-block"><i class="tio-save"></i> {{ translate('Create Banner') }}</button>
